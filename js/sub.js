$(document).ready(function () {
    ...
    */
    ...
    $('.booking_option .option_list .toggle_title').click(function() {
        ...
        $(this).siblings('.booking_option .option_list .option').stop().slideToggle();
    });
    ...
    $('.booking_option input[type=checkbox].c_box + label:nth-of-type(n+6)').hide();
    $('.booking_option input[type=checkbox].c_box + label:nth-of-type(n+6)::before').hide();
    ...
    $('.booking_option .more_btn p').click(function() {
        ...
        $('.booking_option input[type=checkbox].c_box + label:nth-of-type(n+6)').slideToggle();
        $('.booking_option input[type=checkbox].c_box + label:nth-of-type(n+6)::before').slideToggle();
    });
